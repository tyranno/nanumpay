...
def main():
    ...
    # 7월 1명: 사장님
    input("\n▶️ 7월 1명(사장님) 등록을 시작하려면 Enter를 누르세요...")
    ...
    # 7월 2명: 김영수
    input("\n▶️ 7월 2명(김영수) 등록을 시작하려면 Enter를 누르세요...")
    if register_user(cookies, {
        "name": "김영수",
        "phone": "010-1234-5678",
        "bank": "국민은행",
    ...
    # 7월 3명: 이미영
    input("\n▶️ 7월 3명(이미영) 등록을 시작하려면 Enter를 누르세요...")
    if register_user(cookies, {
        "name": "이미영",
        "phone": "010-2345-6789",
        "bank": "신한은행",
    ...
    # 8월 1명: 박철수
    input("\n▶️ 8월 1명(박철수) 등록을 시작하려면 Enter를 누르세요...")
    if register_user(cookies, {
        "name": "박철수",
        "phone": "010-1111-1111",
        "bank": "우리은행",
    ...
    # 8월 2명: 최영희
    input("\n▶️ 8월 2명(최영희) 등록을 시작하려면 Enter를 누르세요...")
    if register_user(cookies, {
        "name": "최영희",
        "phone": "010-2222-2222",
        "bank": "신한은행",
    ...
    # 8월 3명: 정민수
    input("\n▶️ 8월 3명(정민수) 등록을 시작하려면 Enter를 누르세요...")
    if register_user(cookies, {
        "name": "정민수",
        "phone": "010-3333-3333",
        "bank": "국민은행",
    ...
    # 9월 1명: 강민수
    input("\n▶️ 9월 1명(강민수) 등록을 시작하려면 Enter를 누르세요...")
    if register_user(cookies, {
        "name": "강민수",
        "phone": "010-6666-6666",
        "bank": "농협",
